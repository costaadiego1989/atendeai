...
const PROSPECTING_CAMPAIGN_PROVIDERS = [
  ...
  { provide: IDispatchProspectExecutionUseCase, useClass: DispatchProspectExecutionUseCase },
  {
    provide: IDispatchNextProspectCampaignExecutionUseCase,
    useClass: DispatchNextProspectCampaignExecutionUseCase,
  },
  { provide: IRegisterProspectResponseUseCase, useClass: RegisterProspectResponseUseCase },
  { provide: IRegisterProspectStopUseCase, useClass: RegisterProspectStopUseCase },
  {
...
const PROSPECTING_SEARCH_PROVIDERS = [
  { provide: ICreateProspectSearchUseCase, useClass: CreateProspectSearchUseCase },
  { provide: IListProspectSearchesUseCase, useClass: ListProspectSearchesUseCase },
  { provide: IExecuteProspectSearchUseCase, useClass: ExecuteProspectSearchUseCase },
  { provide: IListProspectSearchResultsUseCase, useClass: ListProspectSearchResultsUseCase },
  { provide: IImportProspectSearchResultsUseCase, useClass: ImportProspectSearchResultsUseCase },
  {
  ...
  { provide: PROSPECT_SEARCH_SOURCE_REGISTRY, useClass: ProspectSearchSourceRegistry },
...
const PROSPECTING_ADS_PROVIDERS = [
  ...
  { provide: ISyncProspectAdsLeadsUseCase, useClass: SyncProspectAdsLeadsUseCase },
  { provide: IListProspectLeadCapturesUseCase, useClass: ListProspectLeadCapturesUseCase },
  {
    provide: IImportProspectLeadCapturesUseCase,
    useClass: ImportProspectLeadCapturesUseCase,
  },
  { provide: IProspectLeadCapturesUseCase, useClass: ProspectLeadCapturesUseCase },
...
const PROSPECTING_REPOSITORY_PROVIDERS = [
  { provide: PROSPECT_CAMPAIGN_REPOSITORY, useClass: PrismaProspectCampaignRepository },
  { provide: PROSPECT_EXECUTION_REPOSITORY, useClass: PrismaProspectExecutionRepository },
  { provide: PROSPECT_SEARCH_REPOSITORY, useClass: PrismaProspectSearchRepository },
  {
