...
export const BILLING_NICHE_SEED = [
  {
    ...
    modules: ['CATALOG_INVENTORY', 'CHECKOUT_CONVERSATIONAL', 'COUPONS_PROMOTIONS', 'TEAM_ROUTING'],
  },
  {
    code: 'ECOMMERCE',
    ...
    modules: ['CHECKOUT_CONVERSATIONAL', 'ABANDONED_CART', 'DELIVERY_SHIPPING', 'COUPONS_PROMOTIONS', 'ANALYTICS_PRO'],
  },
  {
    code: 'FOOD',
    ...
    modules: ['CHECKOUT_CONVERSATIONAL', 'CATALOG_INVENTORY', 'DELIVERY_SHIPPING', 'COUPONS_PROMOTIONS', 'EXTRA_WHATSAPP_NUMBER'],
  },
  {
    code: 'HEALTH',
    ...
    modules: ['SCHEDULING_PRO', 'GOOGLE_CALENDAR_MEET', 'SCHEDULING_REMINDERS', 'PREPAID_BOOKING', 'ANALYTICS_PRO'],
  },
  {
    code: 'BEAUTY',
    ...
    modules: ['SCHEDULING_PRO', 'SCHEDULING_REMINDERS', 'PREPAID_BOOKING', 'EXTRA_BRANCH', 'TEAM_ROUTING'],
  },
  {
    code: 'RECOVERY',
    ...
    modules: ['RECOVERY_WALLET', 'RECOVERY_AUTOMATION', 'RECOVERY_REPORTS', 'TEAM_ROUTING', 'ANALYTICS_PRO'],
  },
  {
    code: 'HOME_SERV',
