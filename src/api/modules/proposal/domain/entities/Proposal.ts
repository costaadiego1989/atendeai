...
export class Proposal {
  ...
  public get benefits(): string | null | undefined {
    return this._props.benefits;
  }
  public get items(): ProposalItem[] {
