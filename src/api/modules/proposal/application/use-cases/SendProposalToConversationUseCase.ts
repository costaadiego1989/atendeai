...
export class SendProposalToConversationUseCase {
  constructor(private readonly sendProposalToConversationService: SendProposalToConversationService) {}

  async execute(proposalId: string): Promise<{ conversationId: string; messageId: string; publicUrl: string }> {
