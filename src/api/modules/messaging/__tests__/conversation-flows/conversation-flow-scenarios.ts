...
const recoveryScenarios: ConversationFlowScenario[] = [
  ...
  },
  {
    ...
    title: 'negociacao de parcelamento',
...
export const conversationFlowNiches: ConversationFlowNiche[] = [
  ...
  },
  {
    ...
    strategy: 'SCHEDULING',
    description: 'Servico profissional com agenda estruturada.',
    services: 'Consulta, atendimento, avaliacao e remarcacao.',
    scenarios: schedulingScenarios,
  },
  {
    businessType: 'CLINIC',
    label: 'Clinica',
    strategy: 'SCHEDULING',
    description: 'Clinica com agenda especializada.',
    services: 'Avaliacao, consulta e procedimentos.',
    scenarios: schedulingScenarios,
  },
  {
    ...
    label: 'Recovery',
    strategy: 'RECOVERY',
    description: 'Cobranca, negociacao e recuperacao de receita.',
    services: 'Cobranca, acordos, promessa de pagamento e parcelamento.',
