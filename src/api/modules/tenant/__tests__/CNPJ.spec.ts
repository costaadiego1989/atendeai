...
describe('CNPJ Value Object', () => {
  ...
  it('should throw an error if CNPJ has less than 14 digits', () => {
    expect(() => CNPJ.create('1234567800019')).toThrow(ValidationErrorException);
    expect(() => CNPJ.create('1234567800019')).toThrow('CNPJ must have 14 digits');
  });

  it('should throw an error if CNPJ has more than 14 digits', () => {
    expect(() => CNPJ.create('123456780001955')).toThrow(ValidationErrorException);
  });

  it('should throw an error if CNPJ has all digits equal', () => {
    expect(() => CNPJ.create('11.111.111/1111-11')).toThrow(ValidationErrorException);
  ...
  it('should throw an error if CNPJ verification digits are invalid', () => {
    expect(() => CNPJ.create('12.345.678/0001-00')).toThrow(ValidationErrorException);
  });
