...
export class CreatePromotionDTO {
  ...
  @IsIn(['PERCENTAGE', 'FIXED_AMOUNT']) discountType:
    | 'PERCENTAGE'
    | 'FIXED_AMOUNT';
  ...
  @Type(() => PromotionCouponTargetDTO)
  targets?: PromotionCouponTargetDTO[];
}

export class UpdatePromotionDTO {
  @IsOptional() @IsString() title?: string;
  @IsOptional() @IsString() description?: string;
  @IsOptional() @IsIn(['PERCENTAGE', 'FIXED_AMOUNT']) discountType?:
    | 'PERCENTAGE'
    | 'FIXED_AMOUNT';
