...
export class UpdatePromotionUseCase {
  ...
  async execute(input: UpdatePromotionInput) {
    ...
    if (input.minimumOrder !== undefined) data.minimumOrder = input.minimumOrder;
    ...
    const result = await this.repo.updatePromotion(input.tenantId, input.promotionId, data);
